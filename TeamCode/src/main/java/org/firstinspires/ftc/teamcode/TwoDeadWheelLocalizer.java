...
public final class TwoDeadWheelLocalizer implements Localizer {
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
        ...
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rear-right")));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "shooter-motor-1")));
